...
import id.yanuar.moovis.data.remote.response.EmptyResponse
import id.yanuar.moovis.data.remote.response.ErrorResponse
            ...
            when (response) {
                ...
                is ErrorResponse -> {
                    ...
                    result.addSource(dbSource) { _ ->
                        setValue(Resource.error(response.throwable))
                    }
                }
            }
        }
