...
inline fun <reified T : Activity> fakeActivityInjector(crossinline block: T.() -> Unit)
    ...
    val map = mapOf(Pair<Class<out Activity>,
            Provider<AndroidInjector.Factory<out Activity>>>(T::class.java, Provider { factory }))
